...
//
//     final loginrResponse = loginrResponseFromJson(jsonString);

import 'dart:convert';

LoginResponse loginrResponseFromJson(String str) =>
    LoginResponse.fromJson(json.decode(str));

String loginrResponseToJson(LoginResponse data) => json.encode(data.toJson());
